void drawInfo() {
  ...
  text( "press 'v' to show/hide grid volume", 5, 35 );
  text( "press 's' to show/hide grid skin", 5, 50 );
  text( "press 'c' to disable/enable continuous mode", 5, 65 );
  text( "press 't' to reset grid", 5, 80 );
